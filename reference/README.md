...
Shared vocabulary and sources for the rest of the repo.

## Contents

- [`glossary.md`](glossary.md) — terms as used here, since the field's vocabulary is unstable.
- [`reading-list.md`](reading-list.md) — sources worth returning to, with a line on why.
